...
void GraphWidget::setData(const QVector<double> &time1, const QVector<double> &roll1,
...
{
    time1_ = time1; roll1_ = roll1; pitch1_ = pitch1; yaw1_ = yaw1;
    ve1_ = ve1; vn1_ = vn1; vu1_ = vu1;
    time2_ = time2; roll2_ = roll2; pitch2_ = pitch2; yaw2_ = yaw2;
    ve2_ = ve2; vn2_ = vn2; vu2_ = vu2;
...
{
    // Graph titles and data
    const char *titles[] = {
        "Roll (deg)", "Pitch (deg)", "Yaw (deg)",
        "East Velocity (m/s)", "North Velocity (m/s)", "Up Velocity (m/s)"
    };

    QVector<double> *data1[] = {&roll1_, &pitch1_, &yaw1_, &ve1_, &vn1_, &vu1_};
    QVector<double> *data2[] = {&roll2_, &pitch2_, &yaw2_, &ve2_, &vn2_, &vu2_};
